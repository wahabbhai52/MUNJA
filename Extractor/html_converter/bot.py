...
<a href="https://t.me/ITSGOLU7" style="text-decoration: none; color: inherit;">
...
<a href="https://t.me/ITSGOLU7" style="text-decoration: none; color: inherit;">
  <span class="badge bg-primary me-2">
    <i class="fas fa-robot"></i> Join @ITSGOLU7
  </span>
</a>

            <a href="http://t.me/ITSGOLU7" class="text-decoration-none">
    ...
    pdf_links = "".join(
        ...
        f'<button class="btn-action download" onclick="downloadFile(\'{obfuscate_url(url)}\', \'{name} - @ITSGOLU7.pdf\')" title="Download PDF">'
...
async def handle_txt2html(client: Client, message: Message):
    ...
    try:
        ...
        # Save HTML file with @ITSGOLU7 suffix
        base_name = os.path.splitext(file_name)[0]
        html_file_name = f"{base_name}_@ITSGOLU7 .html"
